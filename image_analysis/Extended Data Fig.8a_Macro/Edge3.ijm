...
roiManager("deselect");
roiManager("save", dir+title+"_LDs.zip"); //we save the original zip to use later
...
//the total number of ROIs minus the first two ones that are the composites
...
roiManager("Delete");
roiManager("Select", 0); //this should be the tumour region
roiManager("Delete");
last=roiManager("Count")-1;
 //this should be the outside region
...
roiManager("Deselect");
roiManager("Select", select1); //this should be the outside region
